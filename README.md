...
````
این هم از مستندات کامل و استانداردِ بخش پایانی مدیریت رمز عبور.

در این متن نیز تمام قواعد فاصله‌گذاری، نیم‌فاصله‌ها و بلوک‌های کد دقیقاً رعایت شده است تا در ویرایشگرها و گیت‌هاب بدون هیچ‌گونه به‌هم‌ریختگی نمایش داده شود. می‌توانید مستقیماً کادر زیر را کپی کنید:
